...
"#;
    ...
    if let serde_yaml::Value::Mapping(map) = &value {
        ...
        if let Some(serde_yaml::Value::Mapping(settings)) =
            map.get(serde_yaml::Value::String("settings".to_string()))
        {
            if let Some(serde_yaml::Value::String(timeout)) =
                settings.get(serde_yaml::Value::String("timeout".to_string()))
            {
