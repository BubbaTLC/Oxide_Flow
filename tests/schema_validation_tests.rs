...
fn test_nested_config_validation() {
    ...
    valid_config.values.insert(
        "path".to_string(),
        serde_yaml::Value::String("/tmp/test.txt".to_string()),
    );
    valid_config.values.insert(
        "encoding".to_string(),
    ...
    valid_config.values.insert(
        "connection".to_string(),
        serde_yaml::Value::Mapping(connection_map),
    );
    ...
    invalid_enum_config.values.insert(
        "path".to_string(),
        serde_yaml::Value::String("/tmp/test.txt".to_string()),
    );
    invalid_enum_config.values.insert(
        "encoding".to_string(),
        serde_yaml::Value::String("invalid-encoding".to_string()),
    );

    // This should fail validation
    assert!(invalid_enum_config
